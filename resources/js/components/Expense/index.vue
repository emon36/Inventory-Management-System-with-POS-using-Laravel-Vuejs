                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <router-link :to="{ name: 'create-expense' }"
                            >Add a new expense</router-link
                        >
                    </li>
                </ol>

                <input type="text" class ="form-control" v-model="searchItem" style="width:300px;" placeholder="search name of expense">
            </div>
              ...
              <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>    
                      <tr v-for= "expense in  search" :key="expense.id">
   ...
   computed:{
     search(){
       return this.expenses.filter(expense => {
         return expense.expense_date.match(this.searchItem)
       })
     }
